...
readInSettings() {
    ...
    global AutoPlay, ShouldUpgradeUnits, LobbySleepTimer, WebhookSleepTimer, LoadingScreenWaitTime, UpdateMessages, ChallengeCDTimer
...
SaveSettings(*) {
    ...
    try {
		...
		content .= "`n[ChallengeCD]"
        content .= "`nChallengeCDDelay=" ChallengeCDTimer.Value
