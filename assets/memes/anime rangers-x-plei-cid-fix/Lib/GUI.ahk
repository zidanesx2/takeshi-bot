...
global currentVersion := "Plei's Cid Fix"
...
ChallengeCDTimerText := arMainUI.Add("Text", "x818 y283.5 w160 h20 +Center Hidden", "Challenge CD Timer")
global ChallengeCDTimer := arMainUI.Add("DropDownList", "x980 y280 w100 h180 Hidden Choose5", ["10 minutes", "15 minutes", "20 minutes", "25 minutes", "30 minutes"])
...
global ModeDropdown := arMainUI.Add("DropDownList", "x818 y53 w140 h180 Choose0 +Center", ["Boss Event", "Story", "Challenge", "Coop"])
...
ShowOnlyControlGroup(groupToShow) {
    ...
    ControlGroups["Timers"] := [
        TimerSettings, LobbySleepText, LobbySleepTimer, WebhookSleepText, WebhookSleepTimer, LoadingScreenWaitTime, LoadingScreenWaitTimeText, VoteTimeoutTimerText, VoteTimeoutTimer, ChallengeCDTimerText, ChallengeCDTimer
    ]
